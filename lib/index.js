	...
	var Scrollbar = function (_Component) {
	    ...
	    _createClass(Scrollbar, [{
	        ...
	        value: function addEventListener() {
	            ...
	            (0, _util.addListener)(thumbHorizontal, 'mouseenter', this.handleTrackMouseEnter);
	            (0, _util.addListener)(thumbHorizontal, 'mouseleave', this.handleTrackMouseLeave);
	            (0, _util.addListener)(thumbHorizontal, 'mousedown', this.handleHorizontalThumbMouseDown);

	            (0, _util.addListener)(thumbVertical, 'mouseenter', this.handleTrackMouseEnter);
	            (0, _util.addListener)(thumbVertical, 'mouseleave', this.handleTrackMouseLeave);
	        ...
	        value: function removeEventListener() {
	            ...
	            (0, _util.removeListener)(thumbHorizontal, 'mouseenter', this.handleTrackMouseEnter);
	            (0, _util.removeListener)(thumbHorizontal, 'mouseleave', this.handleTrackMouseLeave);
	            (0, _util.removeListener)(thumbHorizontal, 'mousedown', this.handleHorizontalThumbMouseDown);

	            (0, _util.removeListener)(thumbVertical, 'mouseenter', this.handleTrackMouseEnter);
	            (0, _util.removeListener)(thumbVertical, 'mouseleave', this.handleTrackMouseLeave);
	            (0, _util.removeListener)(thumbVertical, 'mousedown', this.handleVerticalThumbMouseDown);
	        ...
	        value: function showTracks() {
	            ...
	            (0, _domCss2.default)(trackHorizontal, { filter: "alpha(opacity=100)" });
	            (0, _domCss2.default)(trackVertical, { filter: "alpha(opacity=100)" });

	            (0, _domCss2.default)(thumbHorizontal, { opacity: 1 });
	            (0, _domCss2.default)(thumbVertical, { opacity: 1 });

	            (0, _domCss2.default)(thumbHorizontal, { filter: "alpha(opacity=100)" });
	            (0, _domCss2.default)(thumbVertical, { filter: "alpha(opacity=100)" });
	        }
	    }, {
	        key: 'hideTracks',
	        value: function hideTracks() {
	            ...
	            var _refs12 = this.refs,
	                ...
	                thumbHorizontal = _refs12.thumbHorizontal,
	                thumbVertical = _refs12.thumbVertical;
	            ...
	            this.hideTracksTimeout = setTimeout(function () {
	                ...
	                (0, _domCss2.default)(trackHorizontal, { filter: "alpha(opacity=0)" });
	                (0, _domCss2.default)(trackVertical, { filter: "alpha(opacity=0)" });

	                (0, _domCss2.default)(thumbHorizontal, { opacity: 0 });
	                (0, _domCss2.default)(thumbVertical, { opacity: 0 });

	                (0, _domCss2.default)(thumbHorizontal, { filter: "alpha(opacity=0)" });
	                (0, _domCss2.default)(thumbVertical, { filter: "alpha(opacity=0)" });
	            }, autoHideTimeout);
	        }
	    }, {
	        key: 'detectScrolling',
	        ...
	        value: function render() {
	            ...
	            if (autoHide) {
	                ...
	                thumbHorizontalStyle = _extends({}, thumbHorizontalStyle, trackAutoHideStyle);

	                thumbVerticalStyle = _extends({}, thumbVerticalStyle, trackAutoHideStyle);
	            }
